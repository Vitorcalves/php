                ...
                <?php
                    foreach ($data as $row) {
                        ...
                        <tr>
                            <td><?= $row['id'] ?></td>
                            <td><?= $row['descricao'] ?></td>
                            <td><?= ($row['tipo'] == 1 ? "Produto" : ($row['tipo'] == 2 ? "Serviço" : "...")) ?></td>
                            <td><?= getStatusDescricao($row['statusRegistro']) ?></td>
                            <td>
                                <a href="formProdutoCategoria.php?acao=update&id=<?= $row['id'] ?>" class="btn btn-outline-primary btn-sm"   title="Alteração">Alterar</a>&nbsp;
                                <a href="formProdutoCategoria.php?acao=delete&id=<?= $row['id'] ?>" class="btn btn-outline-danger btn-sm"    title="Exclusão">Excluir</a>&nbsp;
                                <a href="formProdutoCategoria.php?acao=view&id=<?= $row['id'] ?>"   class="btn btn-outline-secondary btn-sm" title="Visualização">Visualizar</a>
                            </td>
                        </tr>
                        <?php
                    }
